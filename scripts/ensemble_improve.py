...
def main():
    ...
    # Individual models
    rf = RandomForestClassifier(n_estimators=200, max_depth=None, min_samples_leaf=2, min_samples_split=2, random_state=42)
    ...
    print("Ensemble (RandomForest + XGBoost) Classifier Results:")
    ...
    model_save_path = Path(__file__).resolve().parent.parent / "models" / "ensemble_model.joblib"
