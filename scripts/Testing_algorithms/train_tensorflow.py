...
def main():
    ...
    model.fit(X_train_scaled, y_train_cat, epochs=50, batch_size=32, validation_split=0.2, verbose=0)
    ...
    model_save_path = Path(__file__).resolve().parent.parent.parent / "models" / "tensorflow_model.h5"
